...
describe('United States - Footer tests (Resolution: galaxyTabS7 800x1280)', () => {

  beforeEach(() => {
      
    cy.setResolution('galaxyTabS7')
  ...
  describe('Menu', () => {
    ...
    describe('Region select menu',() => {
      ...
      beforeEach(() => {
        ...
        cy.get('.px-2').click()
        cy.regionSelectMenuAliasesOnlyMobile()
      ...
      it('Region select menu validation', () => {
        ...
        .should('be.visible')
        .find('a[data-focus="true"]')
        .should('have.attr', 'href', '/es-ar')

        cy.get('@AustraliaItem')
        .should('have.text', 'Australia')
        .should('be.visible')
        .find('a[data-focus="true"]')
        ...
        .should('have.text', 'Colombia & North LATAM')
        .should('be.visible')
        .find('a[data-focus="true"]')
        ...
        cy.get('@ItaliaItem')
        .should('have.text', 'Italia')
        .should('be.visible')
        .find('a[data-focus="true"]')
        .should('have.attr', 'href', '/it-it')
        
        cy.get('@MéxicoItem')
        .should('have.text', 'México')
        .should('be.visible')
        .find('a[data-focus="true"]')
        .should('have.attr', 'href', '/es-mx')
        
        cy.get('@PeruItem')
        .should('have.text', 'Peru')
        .should('be.visible')
        .find('a[data-focus="true"]')
        .should('have.attr', 'href', '/es-pe')

        cy.get('@PolskaItem')
        .should('have.text', 'Polska')
        .should('be.visible')
        .find('a[data-focus="true"]')
    ...
    describe('Platform tab menu', () =>{
      ...
      beforeEach(() => {
        ...
        cy.platformTabAliasesOnlyMobile()
    ...
    describe('Solutions tab menu', () =>{
      ...
      beforeEach(() => {
        ...
        cy.solutionsTabAliasesOnlyMobile()
    ...
    describe('Customers button menu',() => {
      ...
      beforeEach(() => {
        ...
        cy.menuMobileClick()
        cy.customersButtonMenuAliasOnlyMobile()
    ...
    describe('Partners tab menu', () =>{
      ...
      beforeEach(() => {
        ...
        cy.partnersTabAliasesOnlyMobile()
    ...
    describe('Resources tab menu', () =>{
      ...
      beforeEach(() => {
        ...
        cy.resourcesTabAliasesOnlyMobile()
    ...
    describe('Company tab menu', () =>{
      ...
      beforeEach(() => {
        ...
        cy.companyTabAliasesOnlyMobile()
    ...
    describe('Contact us button menu',() => {
      ...
      beforeEach(() => {
        ...
        cy.menuMobileClick()
        cy.contactUsButtonMenuAliasOnlyMobile()
